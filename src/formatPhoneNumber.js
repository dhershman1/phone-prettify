...
var formatPhoneNumber = function(phone, format) {
    ...
    var methods = {
        ...
        longDistance: function(pObj, format) {
            return (format) ? pObj.countryCode+'+'+methods[format](pObj) : pObj.countryCode+'+'+pObj.areaCode+'-'+pObj.localCode+'-'+pObj.lineNumber;
        },

        extension: function(pObj, format) {
            return (format) ? methods[format](pObj)+' x '+pObj.extension : pObj.areaCode+'-'+pObj.localCode+'-'+pObj.lineNumber+' x '+pObj.extension;
        }
    };